...
* _Split_ a dataset into many smaller sub-datasets
* _Apply_ some function to each sub-dataset to compute a result
* _Combine_ the results of the function calls into a one dataset
