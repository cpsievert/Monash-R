...
(1) Using the clean dataset (`gclean`), find the mean expression for each combination of id, trt, and time.
(2) Can you come up with a useful way to display this data?
...
Which carrier has the highest intercept?
