---
title: "Introduction to Plotting Data"
...
library(lubridate)
library(scales)
rates <- read.csv("../data/rates.csv", stringsAsFactors=FALSE)
...
```{r}
curl::curl_download(
  "https://gist.githubusercontent.com/cpsievert/ad9d226c490def59d346/raw/d41c3383100004cc6f13d53e67e62745bddff866/rates.csv",
  "rates.csv"
)
rates <- read.csv("rates.csv", stringsAsFactors = FALSE)
rates$date <- as.Date(rates$date)
rates[1:5,1:8]
```
...
```{r}
poll_loc <- read.csv("../data/polling-places.csv")
...
```{r}
grad <- read.csv("../data/graduate-programs.csv")
