...
With your neighbor, list some ways that R is _different_ from RStudio...

## Getting Started

RStudio is a free and open source integrated development environment (IDE) for R, providing an environment that makes it easier to do data analysis. It contains

- Keeps you organised: Create a _project_ 
- Text editor
- Console window
- Workspace browser
- Graphics, help, file viewer
...
Open the project, you should see the name of this in the right-hand side of the RStudio window
...
Can you reconstruct `plot(forecast(ar1, level = 95))` using __ggplot2__? Here are some hints:
...
Have we encountered any 'pure' function(s)? Can you think of any other pure functions?
...
Image by Karthik Ram (adapted from Hadley Wickham, plyr paper) -> <http://inundata.org/R_talks/meetup/images/splitapply.png>
