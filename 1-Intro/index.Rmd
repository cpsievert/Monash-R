...
```{r, echo = FALSE}
# unfortunate hack needed for the time being
hc <- as.data.frame(hc)
```

## Your turn

Use Rmarkdown to write a pne page report, that does these things:

- Loads the babynames package
- Filters on your name
- Finds the year when your name was most popular
- Plots the number of babies born with this name by year
